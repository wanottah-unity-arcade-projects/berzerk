...
{
    public static EnemyController14 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[13])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[13] = true;
