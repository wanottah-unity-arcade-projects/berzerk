...
{
    public static EnemyController8 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[7])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[7] = true;
