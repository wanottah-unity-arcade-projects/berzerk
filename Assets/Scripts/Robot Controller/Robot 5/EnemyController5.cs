...
{
    public static EnemyController5 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[4])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[4] = true;
