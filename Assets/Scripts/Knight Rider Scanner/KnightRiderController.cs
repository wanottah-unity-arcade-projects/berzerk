...
public class KnightRiderController : MonoBehaviour
{
    ...
    private const float SEQUENCE_TIMER = 0.08f; // 0.07f;
    ...
    public static bool runSensorSweep;
    ...
    private void RunTimer(int led)
    {
        ...
        else if (!doOnce && timer <= 0.0f)
        {
            ...
            if (initialiseKitt)
            {
                AudioController.audioController.PlayAudioClip("Knight Rider Scanner");
