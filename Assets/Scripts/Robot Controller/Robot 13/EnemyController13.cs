...
{
    public static EnemyController13 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[12])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[12] = true;
