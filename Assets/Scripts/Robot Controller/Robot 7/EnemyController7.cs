...
{
    public static EnemyController7 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[6])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[6] = true;
