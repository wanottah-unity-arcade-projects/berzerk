...
{
    public static EnemyController12 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[11])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[11] = true;
