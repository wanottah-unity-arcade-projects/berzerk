...
public class Player2Controller : MonoBehaviour
{
    ...
    public void Initialise()
    {
        ...
        //player1PositionX = playerSpawnPoint[GameController.WEST_EXIT].position.x;
        //player1PositionY = playerSpawnPoint[GameController.WEST_EXIT].position.y;

        PositionPlayer(new Vector2(player1PositionX, player1PositionY));
    ...
    IEnumerator PlayerStart()
    {
        ...
        //RobotController.robotControllerInstance.SpawnRobots();
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        if (!playerIsDead)
        {
            if (other.CompareTag("Enemy") || other.CompareTag("Wall") || other.CompareTag("Enemy_Projectile"))
            {
                Debug.Log(other);
                playerIsDead = true;
                ...
                StartCoroutine(PlayerDead(1.5f));
            }
        }
	}
	...
	/*void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            //StartCoroutine(PlayerOnExitScene(0.5f));
        }
	}*/
    ...
    {       
        ...
        ///GameController.instance.PlayerCollision ();

        Debug.Log("GAME OVER");
	}


	/*IEnumerator PlayerOnExitScene(float delay)
    {
