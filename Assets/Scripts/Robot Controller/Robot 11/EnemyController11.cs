...
{
    public static EnemyController11 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[10])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[10] = true;
