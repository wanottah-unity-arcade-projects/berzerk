...
public class EnemyController15 : MonoBehaviour
{
    public static EnemyController15 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[14])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[14] = true;
