...
public class EnemyController9 : MonoBehaviour
{
    public static EnemyController9 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[8])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[8] = true;
