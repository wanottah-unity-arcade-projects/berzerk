...
{
    public static EnemyController10 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[9])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[9] = true;
