...
{
    public static EnemyController1 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[0])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[0] = true;
