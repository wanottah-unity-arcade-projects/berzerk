...
{
    public static EnemyController4 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[3])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[3] = true;
