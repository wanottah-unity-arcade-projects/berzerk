...
{
    public static EnemyController3 enemyController;
    ...
    {
        if (RobotController.robotController.robotDestroyed[2])
        {
            return;
        }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            RobotController.robotController.robotDestroyed[2] = true;
